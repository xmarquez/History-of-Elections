...
If all goes well (which it probably won't) you should get something that can be used by Final Graphs.R to produce something much like the graphs in the post.